            ...
            >
              ...
              {dropdownOpen && (
                <div className="absolute left-[-50px] mt-0 w-45 bg-white shadow-lg rounded-md p-2">
                  <Link to="/access" href="#" className="block px-4 py-2 hover:text-blue-600 border-b border-gray-200 hover:bg-gray-100">Access Logs</Link>
          ...
          <div>
            ...
            {dropdownOpen && (
              <div className="ml-4 space-y-1">
                <a href="#" className="block border-b border-gray-400 hover:text-blue-600">Access Logs</a>
